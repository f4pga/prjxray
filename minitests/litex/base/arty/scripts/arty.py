...
_io = [
    ...
    (
        "rgb_leds", 0, Subsignal("r", Pins("G6 G3 J3 K1")),
        Subsignal("g", Pins("F6 J4 J2 H6")), Subsignal(
            "b", Pins("E1 G4 H4 K2")), IOStandard("LVCMOS33")),
    ...
    (
        ...
        0,
        Subsignal(
            "a", Pins("R2 M6 N4 T1 N6 R7 V6 U7", "R8 V7 R6 U6 T6 T8"),
            IOStandard("SSTL15")),
        ...
        Subsignal(
            "dq", Pins("K5 L3 K3 L6 M3 M1 L4 M2", "V4 T5 U4 V5 V1 T3 U3 R3"),
    ...
    (
        "eth_clocks", 0, Subsignal("tx", Pins("H16")),
        Subsignal("rx", Pins("F15")), IOStandard("LVCMOS33")),
    (
        "eth", 0, Subsignal("rst_n", Pins("C16")),
        Subsignal("mdio", Pins("K13")), Subsignal("mdc", Pins("F16")),
        Subsignal("rx_dv", Pins("G16")), Subsignal("rx_er", Pins("C17")),
        Subsignal("rx_data", Pins("D18 E17 E18 G17")),
        Subsignal("tx_en", Pins("H15")),
        Subsignal("tx_data", Pins("H14 J14 J13 H17")),
        Subsignal("col", Pins("D17")), Subsignal("crs", Pins("G14")),
        IOStandard("LVCMOS33")),
]
...
class Platform(XilinxPlatform):
    ...
    def __init__(self, toolchain="vivado", programmer="openocd"):
        XilinxPlatform.__init__(
            self, "xc7a35t-csg324-1", _io, toolchain=toolchain)
    ...
    def create_programmer(self):
        if self.programmer == "openocd":
            ...
            return OpenOCD(
                config="board/digilent_arty.cfg", flash_proxy_basename=proxy)
