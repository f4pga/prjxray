...
template <>
Configuration<Spartan6>::PacketData Configuration<Spartan6>::createType2ConfigurationPacketData(const Frames<Spartan6>::Frames2Data& frames,
...
template <>
void Configuration<Spartan6>::createConfigurationPackage(Spartan6::ConfigurationPackage& out_packets,
	...
	// Frame length
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::FLR,
	    {0x0380}));
	...
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::COR2,
	    {0x9ee}));

	// IDCODE
	out_packets.emplace_back(new ConfigurationPacketWithPayload<2, ConfigurationRegister>(
	...
	// Control options
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::CTL,
	    {0x81}));
	...
	// CCLK FREQ
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write,
	...
	// EYE MASK
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::EYE_MASK,
	    {0x0}));
	...
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::CWDT,
	    {0xffff}));

	// GWE cycle during wake-up from suspend
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::PU_GWE,
	    {0x5}));

	// GTS cycle during wake-up from suspend
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::PU_GTS,
	    {0x4}));

	// Reboot mode
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::MODE_REG,
	    {0x100}));

	// General options 1
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::GENERAL1,
	    {0x0}));

	// General options 2
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::GENERAL2,
	    {0x0}));

	// General options 3
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::GENERAL3,
	    {0x0}));

	// General options 4
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::GENERAL4,
	    {0x0}));

	// General options 5
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::GENERAL5,
	    {0x0}));

	// SEU frequency, enable and status
	out_packets.emplace_back(new ConfigurationPacketWithPayload<1, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::SEU_OPT,
	    {0x1be2}));

	// Expected readback signature for SEU detection
	out_packets.emplace_back(new ConfigurationPacketWithPayload<2, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::EXP_SIGN,
	    {0x0, 0x0}));
	...
	// FAR
	out_packets.emplace_back(new ConfigurationPacketWithPayload<2, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::FAR_MAJ,
	    {0x0, 0x0}));
	...
	// Frame data write
	out_packets.emplace_back(new ConfigurationPacket<ArchType::ConfRegType>(
	    2, ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::FDRI,
	    {packet_data}));
	...
	// CRC
	out_packets.emplace_back(new ConfigurationPacketWithPayload<2, ConfigurationRegister>(
	    ConfigurationPacket<ArchType::ConfRegType>::Opcode::Write, ConfigurationRegister::CRC,
	    {0x39, 0xe423}));
