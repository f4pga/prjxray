...
TEST(GlobalClockRegionTest, IsValidFrameAddress) {
	...
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 0, 0, 0));
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 0, 0, 1));
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 0, 1, 0));
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 0, 1, 1));
	addresses.push_back(spartan6::FrameAddress(
	...
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 1, 0, 0));
	addresses.push_back(spartan6::FrameAddress(
	    spartan6::BlockType::CLB_IOI_CLK, 1, 0, 1));
	...
	EXPECT_FALSE(
	    global_clock_region.IsValidFrameAddress(spartan6::FrameAddress(
	        spartan6::BlockType::CLB_IOI_CLK, 0, 0, 2)));
	EXPECT_FALSE(
	    global_clock_region.IsValidFrameAddress(spartan6::FrameAddress(
	        spartan6::BlockType::CLB_IOI_CLK, 0, 2, 0)));
	EXPECT_FALSE(
	    global_clock_region.IsValidFrameAddress(spartan6::FrameAddress(
	        spartan6::BlockType::CLB_IOI_CLK, 2, 0, 0)));
	EXPECT_FALSE(
	    global_clock_region.IsValidFrameAddress(spartan6::FrameAddress(
	        spartan6::BlockType::IOB, 0, 0, 2)));
}
...
TEST(GlobalClockRegionTest,
	...
	ASSERT_TRUE(next_address);
	EXPECT_EQ(*next_address,
	          spartan6::FrameAddress(spartan6::BlockType::BLOCK_RAM,
	                                 0, 0, 2));
}
